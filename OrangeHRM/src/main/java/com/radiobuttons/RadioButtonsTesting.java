...
public class RadioButtonsTesting {
	...
	List<WebElement>group2RadioButtons=radioButtonsBlock.findElements(group1RadioButtonsLocator);
	...
	for(int radioButtonsStatus=0;radioButtonsStatus<group1RadioButtons.size();radioButtonsStatus++)
	{
		...
		log.info(group1RadioButtons.get(radioButtonsStatus).getAttribute("value")+" - "+group1RadioButtons.get(radioButtonsStatus).getAttribute("checked"));
		
		log.info("             "+group2RadioButtons.get(radioButtonsStatus).getAttribute("value")+" - "+group2RadioButtons.get(radioButtonsStatus).getAttribute("checked"));
	}
	    log.info("");

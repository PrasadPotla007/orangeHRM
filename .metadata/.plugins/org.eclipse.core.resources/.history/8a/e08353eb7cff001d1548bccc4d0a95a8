...
public class OrangeHRMHomePage extends OrangeHRMLogInPage {
	...
	@FindBy(id = "menu_pim_viewPimModule")//id="menu_pim_viewPimModule"
	...
	public void validatingHomePageAdminText() throws InterruptedException {
		...
		log.info("The Actual Text Of The OrangeHRM Application Home Page Admin is:- "
				+ actual_OrangeHRMHomePageAdminText);
	...
	public void validatingHomePagePIMText() {
		...
		log.info("The Expected Text Of The OrangeHRM Application Home Page PIM is:- "
				+ expected_OrangeHRMHomePagePIMText);

		Assert.assertEquals(actual_OrangeHRMHomePagePIMText, expected_OrangeHRMHomePagePIMText,
				"The Text Of The PIM is Not Matched:-FAIL");
	...
	public void validatingHomePageLeaveText() {
		...
		log.info("The Actual Text Of The OrangeHRM Application Home Page Leave is:- "
				+ actual_OrangeHRMHomePageLeaveText);

		String expected_OrangeHRMHomePageLeaveText = "Leave";
		log.info("The Expected Text Of The OrangeHRM Application Home Page Leave is:- "
				+ expected_OrangeHRMHomePageLeaveText);

		Assert.assertEquals(actual_OrangeHRMHomePageLeaveText, expected_OrangeHRMHomePageLeaveText,
				"The Text Of The Leave is Not Matched:-FAIL");
	...
	public void validatingHomePageTimeText() {
		...
		log.info(
				"The Actual Text Of The OrangeHRM Application Home Page Time is:- " + actual_OrangeHRMHomePageTimeText);

		String expected_OrangeHRMHomePageTimeText = "Time";
		log.info("The Expected Text Of The OrangeHRM Application Home Page time is:- "
				+ expected_OrangeHRMHomePageTimeText);

		Assert.assertEquals(actual_OrangeHRMHomePageTimeText, expected_OrangeHRMHomePageTimeText,
				"The Text Of The Time is Not Matched:-FAIL");

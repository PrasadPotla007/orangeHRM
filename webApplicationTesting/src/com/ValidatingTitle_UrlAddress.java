...
public class ValidatingTitle_UrlAddress {
	...
	public static void main(String[] args) {
		...
		WebDriver driver;
		String applicationUrlAddress="http://facebook.com"; // variable saved with url Address
		...
		System.out.println(" The expected Title of the Facebookj Home Page is :- "+expected_FacebookHomePageTitle);
